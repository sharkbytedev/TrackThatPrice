        ...
        <div id="about" class="text-center">
            ...
            <div id="features">
                ...
                <div class="sm:flex flex-column justify-center w-4/5 text-center m-auto">
                    <div class="border-0 p-4 w-full sm:w-1/3 m-2 rounded-xl shadow-md bg-slate-50 flex-none">
                        <b>Get notified</b>
                        ...
                        <div class="justify-center flex text-center w-full">
                            <img class="select-none" src="/images/bell.svg" alt="" srcset="">
                        </div>
                    </div>
                    <div class="border-0 p-4 w-full sm:w-1/3 m-2 rounded-xl shadow-md bg-slate-50 flex-none">
                        <b>Wide support</b>
                        <p class="text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta, porro?</p>
                        <div class="justify-center flex text-center w-full">
                            <img class="select-none" src="/images/tool.svg" alt="" srcset="">
                        </div>
                    </div>
                    <div class="border-0 p-4 w-full sm:w-1/3 m-2 rounded-xl shadow-md bg-slate-50 flex-none">
                        <b>Historical data</b>
                        <p class="text-left">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta, porro?</p>
                        <div class="justify-center flex text-center w-full">
                            <img class="select-none" src="/images/bar-chart-2.svg" alt="" srcset="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="prices">
                ...
                <div class="w-5/6 sm:w-2/3 m-auto sm:flex flex-column sm:flex-row justify-center">
                    <div class="bg-white my-2  sm:my-2 sm:mx-2 p-2 w-full sm:w-1/2 flex-none shadow-md rounded-xl bg-slate-50">
